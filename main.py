...
def menu():
    ...
    formatted_text_play = constantes.FONT.render(message_play, False, constantes.WHITE)
    formatted_text_quit = constantes.FONT.render(message_quit, False, constantes.WHITE)
...
while True:
    ...
    formatted_text_blue = constantes.FONT_PONTUACAO.render(message_blue, False, constantes.WHITE)
    message_red = f"Pontos Vermelho: {constantes.RED_POINTS}"
    formatted_text_red = constantes.FONT_PONTUACAO.render(message_red, False, constantes.WHITE)
    events()
